...
const STATS = [
  ...
  { value: 8, label: 'Months operating' },
];
    ...
    <section className="section-y">
      <div className="wrap">
        <Reveal direction="zoom">
          <div className="relative grid grid-cols-2 md:grid-cols-2 gap-5 sm:gap-6 p-8 sm:p-10 lg:p-12 rounded-[24px] sm:rounded-[28px] border border-white/[0.22] bg-gradient-to-br from-violet-900/50 to-surface/60 overflow-hidden">
            <div
              aria-hidden
