...
const CAPABILITIES = [
  ...
  { tag: 'Celebrity',     img: '/sectors/talent.jpg', items: ['Artist Bookings ', 'Celebrity Handling', 'Artist Hospitality','Technical Rider ','Green Room Management', 'Stage Entry','Performance Flow','VIP Handling'] },
